...
public class TestBase {
	...
	public TestBase()   // This is the Constructor - Constructor name is same as Class name.
	{
		...
		try {
			...
			prop = new Properties();
			FileInputStream ip = new FileInputStream("C:\\TEST Automation - Selenium Java\\eclipse-workspace\\TMR_D365_Test_Automation\\src\\main\\java\\com\\qa\\config\\config.properties");
			prop.load(ip);
